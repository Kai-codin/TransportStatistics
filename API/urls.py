...
from .views import StopViewSet, enrich_stop, fleet_search, train_fleet, live_trains_proxy, refresh_train_detail, GetTrainOperatorsViewSet, train_route
...
urlpatterns = [
    ...
    path('train-route/', train_route, name='train-route'),
